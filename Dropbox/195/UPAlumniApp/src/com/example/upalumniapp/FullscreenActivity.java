...
//import ph.up.edu.itdc.android.mylib.BookmarkTabHolder;
//import ph.up.edu.itdc.android.mylib.R;
...
public class FullscreenActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		//final View controlsView = findViewById(R.id.mainframe);
		...
		newsbutton.setOnClickListener(new View.OnClickListener() {
			...
			//	finish();
				Intent newsIntent = new Intent(view.getContext(),ViewNews.class);
